...
public class BottomSheetHowAboutThisFilterDialog extends BottomSheetDialogFragment implements View.OnClickListener {
    ...
    public BottomSheetHowAboutThisFilterDialog() {
    }

    public BottomSheetHowAboutThisFilterDialog(Context context, int option) {
