...
public class BottomSheetHallOfFameFilterDialog extends BottomSheetDialogFragment implements View.OnClickListener {
    ...
    public BottomSheetHallOfFameFilterDialog() {
    }

    public BottomSheetHallOfFameFilterDialog(Context context, int option) {
