...
public class BottomSheetWithYouMbtiFilterDialog extends BottomSheetDialogFragment implements View.OnClickListener {
    ...
    public BottomSheetWithYouMbtiFilterDialog() {
    }

    public BottomSheetWithYouMbtiFilterDialog(Context context) {
